...
if __name__ == "__main__":
    # SETTING UP
    nb_roi=9
    experiment_path = 'J:\\Sylvain_Moser\\BPC after labmeeting2\\single_fish_para_vs_starved\\07122017_2'
    output_path = "C:\\data"
    ...
    for trial in trials:
        ...
        if os.path.isdir(trial_path) and trial not in trials_df["trial_name"].values:  # if the trial path goes to a directery

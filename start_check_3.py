...
if __name__ == "__main__" :
    ...
    roi_folder="J:\\Sylvain_Moser\\check\\rois"
    #start_video_name="14-21-09.091.avi"
    ...
    if not os.path.exists(roi_folder):
        ...
        rois_df.to_csv("J:\\Sylvain_Moser\\check\\rois\\check.csv",index=False)
    ...
    analyse_conditions = []
    rois_df=pd.read_csv("J:\\Sylvain_Moser\\check\\rois\\check.csv")
    ...
    rois_paramecia_counts.columns = ["up left","up right","bottom left","bottom right"]
